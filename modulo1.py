...
if __name__ == "__main__":
    ...
    if not all([api_key, secret_key, passphrase]):
        ...
        async def main():
                ...
                try:
                    ...
                    if "data" in data:
                        ...
                        if current_time - process_message.last_print_time >= 15:  # Intervalo de 15 segundos
                            ...
                            # Escribir el resumen en el archivo de log
                            logging.info(f"[Resumen] Canal: {resumen['Canal']}, Instrumento: {resumen['Instrumento']}, Datos: {resumen['Datos']}")
            ...
            await client.receive_messages(client.process_message)
